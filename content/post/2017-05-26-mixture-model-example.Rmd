...
author: ~
date: '2017-05-26'
slug: mixture-model-example
categories: []
tags: []
---

```{r,echo=FALSE}
knitr::opts_chunk$set(message=FALSE, comment='.', cache=FALSE, autodep=TRUE)
```
...
```{r}
mod <- mcode("A", code) %>% update(end=72, delta=0.1)
...
```
The profile in pink was for `POP==2` or the lower clearance profile.
