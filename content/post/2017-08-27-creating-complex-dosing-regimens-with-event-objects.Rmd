...
# Introduction
There are some new functions that work from event objects that 
we'd like to introduce with this blog post.  The focus 
...
easily create regularly irregular dosing patterns.

__NOTE__ these functions are new to `mrgsolve` and only 
available on the development version of this package [on 
...
Now, let's imagine a dosing sequence of alternating 100 mg daily for a 
...
according to the end time from the preceeding event.
