...
The following is a simple example to illustrate the basics of how `mrgsolve` works.  You can find more examples and usage vignettes in the links above or in the "Topics" menu in the nav bar at the top of the [mrgsolve.github.io](https://mrgsolve.github.io) main page.
